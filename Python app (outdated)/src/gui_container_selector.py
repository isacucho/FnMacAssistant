...
class ContainerSelectorWindow:
    def __init__(self, parent, containers, app_manager):
        ...
        # Let the window size itself based on content, but set a reasonable
        # minimum
    ...
    def _setup_ui(self):
        ...
        # Right-click binding (Mac uses Button-2 or Control-Click usually, but
        # Button-3 is standard right click)
        ...
        self.info_label = ttk.Label(
            footer_frame,
            text="Select a container to continue",
            foreground="gray")
    ...
    def _populate_list(self):
        ...
        for container in self.containers:
            ...
            # Calculate size (this might take a moment, could be threaded but
            # for now it's ok)
        ...
        if messagebox.askyesno(
            ...
            try:
                if self.app_manager.delete_container(container_path):
                    ...
                    messagebox.showinfo(
                        "Success", "Container deleted.", parent=self.window)
